...
class PulseLayer:
    ...
    def _initialize(self) -> None:
        ...
        try:
            try:
                from .scup_tracker import get_tracker as get_scup_tracker
            except ImportError:
                try:
                    from dawn.subsystems.schema.scup_tracker import SCUPTracker
                    def get_scup_tracker():
                        return SCUPTracker()
                except ImportError:
                    def get_scup_tracker():
                        return None
            ...
            try:
                from .pulse_tracker import get_tracker as get_pulse_tracker
            except ImportError:
                def get_pulse_tracker():
                    return None
